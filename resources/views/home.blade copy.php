    ...
    <div class="desktopx">
        ...
        <div class="bg-teal py-5" id="sourcecode">
            <div class="container">
                ...
                <div class="row gx-4 pt-4">
                    @foreach ($getSourceCode as $scode)
                        <div class="col">
                            <div class="bg-white rounded-4 p-4">
                                <a href="sourcecode.html" class="text-decoration-none">
                                    <img src="{{ asset('storage/' . $scode->image) }}" class="img-fluid rounded-4">
                                    <div class="p-2">
                                        <div class="fw-bold text-black pb-2">{{ $scode->name }}: {{ $scode->judul }}
                                        </div>
                                        <div class="text-primary pb-2">{{ $scode->sub_judul }}</div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-xl-4 col-sm-12 col-xs-12 col-md-12">
                    ...
                    <div class="text-white pt-4 d-flex align-items-center"><img src="assets/img/icon/copyright.png"
                ...
                <div class="col-lg-2 col-xl-2 col-sm-6 col-xs-6 col-md-6">
                    ...
                    <div><a href="product.html?pos" class="text-decoration-none text-white fw-light pb-2">POSBro</a>
                    </div>
                    <div><a href="product.html?gym" class="text-decoration-none text-white fw-light pb-2">GYMBro</a>
                    </div>
