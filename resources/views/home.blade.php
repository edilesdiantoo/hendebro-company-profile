                ...
                <div class="row">
                    ...
                    <div class="row pt-3">
                        <div class="col">
                            ...
                            <div><a class="text-decoration-none text-white fw-light pb-1"
                                    href="sourcecode.html">Landing Page</a></div>
                            <div><a class="text-decoration-none text-white fw-light pb-1" href="sourcecode.html">Point
                                    Of Sales (POS)</a>
                            </div>
                            <div><a class="text-decoration-none text-white fw-light pb-1"
                                    href="sourcecode.html">Company Profile</a></div>
                            <div><a class="text-decoration-none text-white fw-light pb-1"
                                    href="sourcecode.html">Sistem Pakar</a></div>
                        </div>
                        <div class="col">
                            <div class="fw-semibold text-white pb-2">Product</div>
                            <div><a class="text-decoration-none text-white fw-light pb-1"
                                    href="product.html?pos">POSBro</a></div>
                            <div><a class="text-decoration-none text-white fw-light pb-1"
                                    href="product.html?gym">GYMBro</a></div>
                            <div><a class="text-decoration-none text-white fw-light pb-1"
                    ...
                    <div class="row pt-3">
                        <div class="col">
                            ...
                            <div><a class="text-decoration-none text-white fw-light pb-1"
                                    href="hosting.html">Domain</a></div>
                            <div><a class="text-decoration-none text-white fw-light pb-1" href="hosting.html">Cloud
                                    Hosting</a></div>
                            <div><a class="text-decoration-none text-white fw-light pb-1" href="hosting.html">Company
                                    Profile</a></div>
                            <div><a class="text-decoration-none text-white fw-light pb-1" href="hosting.html">Sistem
                                    Pakar</a></div>
                        </div>
                        <div class="col">
                            <div class="fw-semibold text-white pb-2">Company</div>
                            <div><a class="text-decoration-none text-white fw-light pb-1" href="about.html">About</a>
                            </div>
                            <div><a class="text-decoration-none text-white fw-light pb-1"
